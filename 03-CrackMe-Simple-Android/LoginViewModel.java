package org.bfe.crackmesimple.ui;

import androidx.lifecycle.LiveData;
import androidx.lifecycle.MutableLiveData;
import androidx.lifecycle.ViewModel;
import dalvik.system.DexClassLoader;
import org.bfe.crackmesimple.R;
...
public class LoginViewModel extends ViewModel {
    ...
    public void loginDataChanged(String str) {
        if (!isPasswordValid(str)) {
            this.loginFormState.setValue(new LoginFormState(null, Integer.valueOf((int) R.string.invalid_password)));
        } else if (!str.startsWith("HL")) {
            this.loginFormState.setValue(new LoginFormState(null, Integer.valueOf((int) R.string.has_to_start_with)));
        } else {
